<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <h4 class="m-b-lg">
            Referans fotoğrafları <small>(<?=$item->title?>)</small>
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="widget">
            <div class="widget-body">
                <form data-url="<?=base_url("references/refreshImageList/$item->id")?>" action="<?=base_url("references/imageUpload/$item->id")?>" id="dropzone" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?=base_url('references/imageUpload/'.$item->id)?>'}">

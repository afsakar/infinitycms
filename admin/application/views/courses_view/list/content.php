    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="widget p-lg">
            ...
            <div class="alert alert-info text-center">
                <p>Burada herhangi bir kayıt bulunmamaktadır. <?php if(permission("courses", "add")): ?>Kayıt eklemek için <a href="<?=base_url('courses/addForm')?>" class="alert-link">buraya</a> tıklayın.<?php endif; ?></p>
            </div>
                        ...
                        <?php foreach ($items as $item): ?>
                            <tr id="ord-<?=$item->id?>">
                                ...
                                <td class="text-center">
                                    ...
                                    <?php endif; ?>
                                    <?php if(permission("courses", "delete")): ?>

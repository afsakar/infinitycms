    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="widget p-lg videoListContainer">
            ...
            <div class="alert alert-info text-center">
                <p>Burada herhangi bir kayıt bulunmamaktadır. <?php if(permission("email_settings", "add")): ?>Kayıt eklemek için <a href="<?=base_url("email_settings/addForm")?>" class="alert-link">buraya</a> tıklayın.<?php endif; ?></p>
            </div>

            <?php else: ?>

                <div class="table-responsive">
                    <table id="responsive-datatable" class="table table-striped table-email table-bordered" cellspacing="0" width="100%">
                        <thead>
